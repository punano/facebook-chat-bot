...
var server_port =  process.env.OPENSHIFT_NODEJS_PORT || process.env.PORT || 50000;
var server_host = process.env.OPENSHIFT_NODEJS_IP || process.env.IP || '127.0.0.1';

server.listen(server_port , server_host, function() {
  console.log("Chat bot server listening at %s:%d ", server_port, server_host);
});
